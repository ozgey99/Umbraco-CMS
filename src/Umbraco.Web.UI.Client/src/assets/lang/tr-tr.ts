...
export default {
	actions: {
		...
		changeDataType: 'Veri Türünü Değiştir',
		changeDocType: 'Belge Türünü Değiştir',
		chooseWhereToCopy: 'Nereye kopyalayacağınızı seçin',
		chooseWhereToImport: 'Nereden içe aktaracağınızı seçin',
		chooseWhereToMove: 'Taşıyacağınız yeri seçin',
		copy: 'Kopyala',
		copyTo: 'Kopyalayacağınız yer',
		create: 'Oluştur',
		createblueprint: 'Belge Şablonu Oluştur',
		...
		folderDelete: 'Klasörü sil',
		folderRename: 'Klasörü yeniden adlandır',
		import: 'İçe Aktar',
		...
		rights: 'İzinler',
		rollback: 'Geri al',
		sendtopublish: 'Yayınlamaya Gönder',
		...
		update: 'Güncelle',
		wasCopiedTo: 'konumuna kopyalandı,',
		wasDeleted: 'silindi,',	
	...
	actionDescriptions: {
		...
		browse: 'Bir düğümü görüntülemek için erişime izin ver',
		changeDocType: 'Bir düğümün belge türünü değiştirmek için erişime izin ver',
		copy: 'Bir düğümü kopyalamak için erişime izin ver',
		create: 'Düğüm oluşturmak için erişime izin ver',
		delete: 'Düğümleri silmek için erişime izin ver',
		move: 'Bir düğümü taşımak için erişime izin ver',
		protect: 'Bir düğümün genel erişimini ayarlamak ve değiştirmek için erişime izin ver',
		publish: 'Bir düğüm yayınlamak için erişime izin ver',
		unpublish: 'Bir düğümü yayından kaldırmak için erişime izin ver',
		rights: 'Bir düğümün izinlerini değiştirmek için erişime izin ver',
		...
		sort: 'Düğümlerin sıralama düzenini değiştirmek için erişime izin ver',
		translate: 'Bir düğümü çevirmek için erişime izin ver',
		update: 'Bir düğümü kaydetmek için erişime izin ver',
		createblueprint: 'Belge Şablonu oluşturmak için erişime izin ver',
		notify: 'İçerik düğümlerinin bildirimlerini ayarlamak için erişime izin ver',
	},
	apps: {
		umbContent: 'İçerik',
		umbInfo: 'Bilgi',
	...
	buttons: {
		...
		select: 'Seç',
		somethingElse: 'Başka bir şey yap',
		bold: 'Kalın',
		...
		styleChoose: 'Stil seç',
		styleShow: 'Stilleri göster',
		tableInsert: 'Tablo ekle',
		generateModelsAndClose: 'Modelleri oluştur ve kapat',
		saveAndGenerateModels: 'Modelleri kaydet ve oluştur',
		undo: 'Geri Al',
		redo: 'Yinele',
	...
	auditTrails: {
		assigndomain: 'Etki alanı atandı: %0%',
		atViewingFor: 'Görüntülenen:',
		delete: 'İçerik silindi',
		unpublish: 'İçerik yayından kaldırıldı',
		unpublishvariant: 'İçerik şu diller için yayından kaldırıldı: %0%',
		publish: 'İçerik yayınlandı',
		publishvariant: 'İçerik şu diller için yayınlandı: %0%',
		save: 'İçerik kaydedildi',
		savevariant: 'İçerik şu diller için kaydedildi: %0%',
		move: 'İçerik taşındı',
		copy: 'İçerik kopyalandı',
		rollback: 'İçerik geri alındı',
		sendtopublish: 'İçerik yayınlamaya gönderildi',
		sendtopublishvariant: 'İçerik şu diller için yayınlamaya gönderildi: %0%',
		sort: 'Kullanıcı tarafından gerçekleştirilen alt öğeleri sırala',
		custom: '%0%',
		contentversionpreventcleanup: 'Temizlik şu versiyon için devre dışı bırakıldı: %0%',
		contentversionenablecleanup: 'Temizlik şu versiyon için etkinleştirildi: %0%',
		smallAssignDomain: 'Etki Alanı Ata',
		smallCopy: 'Kopyala',
		...
		smallUnpublishVariant: 'Yayından Kaldır',
		smallRollBack: 'Geri Al',
		smallSendToPublish: 'Yayınlamak İçin Gönder',
		smallSendToPublishVariant: 'Yayınlamak İçin Gönder',
		smallSort: 'Sırala',
		smallCustom: 'Özel',
		smallContentVersionPreventCleanup: 'Kaydet',
		smallContentVersionEnableCleanup: 'Kaydet',
	...
	content: {
		...
		listViewNoContent: 'Hiçbir alt öğe eklenmedi',
		listViewNoMembers: 'Hiçbir üye eklenmedi',
		...
		noProperties: 'Bu öğe için hiçbir içerik eklenemez',
		otherElements: 'Özellikler',
		parentNotPublished: 
			"Bu belge yayınlandı, ancak '%0%' üst öğesi yayından kaldırıldığı için görünmüyor",
		parentCultureNotPublished: 
			"Bu kültür yayınlandı, ancak '%0%' üst öğe üzerinde yayından kaldırıldığı için görünmüyor",
		...
		publishDescendantsWithVariantsHelp:
			'Varyantları ve altındaki aynı türde varyantları yayınlayın ve böylece içeriklerini herkese açık hale getirin.',
		noVariantsToProcess: 'Geçerli hiçbir varyant yok',
		releaseDate: 'Şu tarihte yayınla',
		unpublishDate: 'Şu tarihte yayından kaldır',
		removeDate: 'Tarihi Temizle',
		setDate: 'Tarihi ayarla',
		sortDone: 'Sıralama düzeni güncellendi',
		sortHelp:
		...
		captionTextOptional: 'Altyazı (isteğe bağlı)',
		type: 'Tür',
		unpublish: 'Yayından Kaldır',
		...
		uploadClear: 'Dosyaları kaldır',
		uploadClearImageContext: 'Resmi medya öğesinden kaldırmak için buraya tıklayın',
		uploadClearFileContext: 'Dosyayı medya öğesinden kaldırmak için buraya tıklayın',
		urls: 'Belgeye bağlantı',
		memberof: 'Üyesi olduğu grup(lar)',
		notmemberof: 'Üyesi olmadığı grup(lar)',
		childItems: 'Alt öğeler',
		target: 'Hedef',
		scheduledPublishServerTime: 'Bu, sunucuda şu zamana denk gelir:',
		scheduledPublishDocumentation:
			'<a href="https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones" target="_ blank">Bu ne anlama geliyor? </a>',
		...
		nestedContentEditorNotSupported:
			'%0% özelliği, %1% düzenleyicisini kullanıyor ve bu, Yuvalanmış İçerik tarafından desteklenmiyor.',
		nestedContentNoContentTypes: 'Bu özellik için hiçbir İçerik Türü yapılandırılmadı.',
		nestedContentAddElementType: 'Öğe Türü Ekle',
		nestedContentSelectElementTypeModalTitle: 'Öğe Türü Seç',
		nestedContentGroupHelpText:
			'Özelliklerinin görüntülenmesi gereken grubu seçin. Boş bırakılırsa, Öğe Türündeki ilk grup kullanılacaktır.',
		nestedContentTemplateHelpTextPart1: 
			'Adını her bir öğeyle karşılaştırmak için bir Angular ifadesi girin. Şunu kullanın: ',
		nestedContentTemplateHelpTextPart2: 'şu öğe dizinini görüntülemek için:',
		nestedContentNoGroups:
			'Seçilen öğe türü desteklenen hiçbir grubu içermiyor (sekmeler bu düzenleyici tarafından desteklenmiyor, ya gruplara çevirin ya da Blok Listesi düzenleyicisini kullanın).',
		addTextBox: 'Başka bir metin kutusu ekle',
		removeTextBox: 'Bu metin kutusunu kaldır',
		...
		languagesToSendForApproval: 'Onaya hangi dilleri göndermek istersiniz?',
		...
		variantsToPublish: 'Hangi varyantları yayınlamak istersiniz?',
		variantsToSave: 'Hangi varyantların kaydedileceğini seçin.',
		publishRequiresVariants: 'Yayınlamanın gerçekleşmesi için şu varyantlar gereklidir:',
		notReadyToPublish: 'Yayınlamaya hazır değiliz',
		readyToPublish: 'Yayınlamaya hazır mısınız?',
		readyToSave: 'Kaydetmeye hazır mısınız?',
		resetFocalPoint: 'Odak noktasını sıfırla',
		...
		nodeIsInTrash: "Bu öğe Geri Dönüşüm Kutusunda",
		variantSaveNotAllowed: 'Kaydetmeye izin verilmiyor',
		variantPublishNotAllowed: 'Yayınlamaya izin verilmiyor',
		variantSendForApprovalNotAllowed: 'Onaya göndermeye izin verilmiyor',
		variantScheduleNotAllowed: 'Planlamaya izin verilmiyor',
		variantUnpublishNotAllowed: 'Yayından kaldırmaya izin verilmiyor',
		selectAllVariants: 'Bütün varyantları seç',
	...
	media: {
		...
		orClickHereToUpload: 'veya dosyaları seçmek için buraya tıklayın',
		disallowedFileType: 'Bu dosya yüklenemiyor, onaylanmış bir dosya türüne sahip değil',
		disallowedMediaType: "Bu dosya yüklenemiyor, '%0%' takma adına sahip olan medya türüne burada izin verilmiyor",
		invalidFileName: 'Bu dosya yüklenemiyor, geçerli bir dosya adına sahip değil',
		...
		fileSecurityValidationFailure: 'Bir veya daha fazla güvenlik doğrulaması başarısız oldu',
		moveToSameFolderFailed: 'Üst ve hedef klasörler aynı olamaz',
		uploadNotAllowed: 'Bu konumda yüklemeye izin verilmiyor.',
	},
	member: {
